...
public class HangGlidePermissions {
	
	private static Permissions permissionsPlugin;
	public static boolean permissionsEnabled = false;
	private static volatile HangGlidePermissions instance;
	...
	public boolean use(Player player)
	{
	  ...
	  public static HangGlidePermissions getInstance() {
	    	if (instance == null) {
	    	instance = new HangGlidePermissions();
	    	}
	    	return instance;
	    	}
}
