...
public class HangGlide extends JavaPlugin{

	private static final Logger log = Logger.getLogger("Minecraft");
	 private final HangGlidePlayerListener playerListener = new HangGlidePlayerListener(this);
	    private final HangGlideBlockListener blockListener = new HangGlideBlockListener(this);
	    private final HangGlideEntityListener entityListener = new HangGlideEntityListener(this);
	    private final HangGlideVehicleListener vehicleListener = new HangGlideVehicleListener(this);
	    ...
	    public void onEnable() {
	        ...
	        pm.registerEvent(Event.Type.PLAYER_INTERACT_ENTITY, playerListener, Priority.High, this); 
	    ...
	    //    getCommand("pos").setExecutor(new SalamiTestPosCommand(this));
	      //("debug").setExecutor(new SalamiTEstDebugCommand(this));
	        ...
	        // EXAMPLE: Custom code, here we just output some info so we can check all is well
	        HangGlidePermissions.initialize(getServer());
	        setupPermissions();
